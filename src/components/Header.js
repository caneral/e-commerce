            ...
            <div className="grid grid-cols-1">
                <div>
                    ...
                    <div className="grid grid-cols-5 items-center ">
                        ...
                        <div className="flex flex-row space-x-3 justify-end w-full col-span-2 mx-auto">
                            <button className=" rounded-md px-8 py-2 font-bold text-gray-700 mx-auto">Konum</button>
                            <button className="border-2 border-gray-base rounded-md px-8 py-2 font-bold text-gray-700">Giriş Yap</button>
                            <button className="border-2 border-gray-base bg-gray-base text-white rounded-md px-8 py-2 font-bold">Sepetim</button>
                        </div>
                    </div>
                </div>
                <div>
